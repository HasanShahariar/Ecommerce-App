...
export class CouponService {
  ...
  createCoupon(data): Observable<any> {
    ...
    return this.httpClient
      .post<any>(this.baseUrl + 'coupons', data)
  ...
  updateCoupon(data): Observable<any> {
    ...
    return this.httpClient
      .put<any>(this.baseUrl + 'coupons/' + data.id, data)
      .pipe(catchError(this.handleError));
  }

  getCouponByPagination(page?, itemPerPage?, searchKey?) {
  ...
  getCouponById(id): Observable<any> {
    return this.httpClient
      .get<any>(this.baseUrl + 'coupons/' + id)
      .pipe(catchError(this.handleError));
  }

  deleteCoupon(id: number): Observable<void> {
    return this.httpClient
      .delete<void>(this.baseUrl + 'coupons/' + id)
      .pipe(catchError(this.handleError));
  }
