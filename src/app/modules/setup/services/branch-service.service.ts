...
export class BranchServiceService {
  onBranchCreated: Subject<any> = new Subject<any>();
  ...
  createBranch(data): Observable<any> {
    ...
    return this.httpClient
      .post<any>(this.baseUrl + 'Branch', data)
      .pipe(catchError(this.handleError));
  }

  updateBranch(data): Observable<any> {
    return this.httpClient
      .put<any>(this.baseUrl + 'Branch/' + data.id, data)
      .pipe(catchError(this.handleError));
  }

  getById(id): Observable<any> {
    return this.httpClient
      .get<any>(this.baseUrl + 'Branch/' + id)
      .pipe(catchError(this.handleError));
  }
  deleteBranch(id: number): Observable<void> {
    return this.httpClient
      .delete<void>(this.baseUrl + 'Branch/' + id)
      .pipe(catchError(this.handleError));
  }

  getBranchPagination(page?, itemPerPage?, searchKey?) {
