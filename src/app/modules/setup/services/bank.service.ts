...
export class BankService {
  onBankCreated: Subject<any> = new Subject<any>();
  ...
  createBank(data): Observable<any> {
    ...
    return this.httpClient
      .post<any>(this.baseUrl + 'Bank', data)
      .pipe(catchError(this.handleError));
  }

  updateBank(data): Observable<any> {
    return this.httpClient
      .put<any>(this.baseUrl + 'Bank/' + data.id, data)
      .pipe(catchError(this.handleError));
  }

  getById(id): Observable<any> {
    return this.httpClient
      .get<any>(this.baseUrl + 'Bank/' + id)
      .pipe(catchError(this.handleError));
  }
  deleteBank(id: number): Observable<void> {
    return this.httpClient
      .delete<void>(this.baseUrl + 'Bank/' + id)
      .pipe(catchError(this.handleError));
  }

  getBankPagination(page?, itemPerPage?, searchKey?) {
